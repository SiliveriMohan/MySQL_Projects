...
INSERT INTO CustomerDetails (CustomerID, FullName, Email, Phone,
Identity_proof)
VALUES
...
INSERT INTO Employees (EmployeeID, Emp_name, Department, Emp_salary,
Emp_Position)
VALUES
...
INSERT INTO Trains (TrainID, TrainName, T_DepartureTime, T_ArrivalTime,
T_Origin, T_Destination, DestinationID)
VALUES
...
INSERT INTO Flights (FlightID, FlightNumber, Airline, FL_DepartureTime,
FL_ArrivalTime, FL_Origin, FL_Destination, DestinationID)
VALUES
...
INSERT INTO Buses (BusID, BusNumber, Operator, B_DepartureTime,
B_ArrivalTime, B_Origin, B_Destination, DestinationID)
VALUES
...
INSERT INTO Cruise (CruiseID, CruiseName, CR_DepartureTime,
CR_ArrivalTime, CR_Origin, CR_Destination, DestinationID)
VALUES
...
INSERT INTO Cars (CarID, CarModel, PlateNumber, Capacity, C_Origin,
C_Destination, DestinationID)
VALUES
...
CustomerDetails_reneeka(CustomerID)
);

INSERT INTO Payments (PaymentID, PaymentMethod, PaymentAmount,
...
INSERT INTO Bookings (BookingID, CustomerID, Booking_status, PaymentID,
Booking_time, Transport, Origin, Destination)
VALUES
 (1, 1, 'Confirmed', 101, '2024-03-10 08:00:00', (SELECT Operator FROM
Buses_amishi WHERE DestinationID = 201), 'Delhi','Mumbai'),
 (2, 2, 'Confirmed', 102, '2024-03-10 10:00:00', (SELECT PlateNumber FROM
Car_chahel WHERE DestinationID = 202), 'Mumbai', 'Pune'),
 (3, 3, 'Confirmed', 103, '2024-03-10 12:00:00', (SELECT FlightNumber FROM
Flights_amishi WHERE DestinationID = 203), 'Delhi', 'Chennai'),
 (4, 4, 'Confirmed', 104, '2024-03-10 14:00:00', (SELECT FlightNumber FROM
Flights_amishi WHERE DestinationID = 204), 'Mumbai', 'Bangalore'),
 (5, 5, 'Confirmed', 105, '2024-03-10 16:00:00', (SELECT CruiseName FROM
Cruise_amishi WHERE DestinationID = 303 AND CR_Origin='Singapore'), 'Singapore', 'Dubai'),
 (6, 6, 'Confirmed', 106, '2024-03-10 18:00:00', (SELECT Operator FROM
Buses_amishi WHERE DestinationID = 206), 'Mumbai', 'Kolkata'),
 (7, 7, 'Confirmed', 107, '2024-03-10 20:00:00', (SELECT PlateNumber FROM
Car_chahel WHERE DestinationID = 103), 'Jaipur', 'Indore' ),
 (8, 8, 'Confirmed', 108, '2024-03-10 22:00:00', (SELECT TrainName FROM
Trains_reneeka WHERE DestinationID = 204), 'Kolkata', 'Bangalore'),
 (9, 9, 'Confirmed', 109, '2024-03-11 01:00:00', (SELECT FlightNumber FROM
Flights_amishi WHERE DestinationID = 203), 'Delhi', 'Chennai'),
 (10, 10, 'Confirmed', 110, '2024-03-11 03:00:00', (SELECT CruiseName FROM
Cruise_amishi WHERE DestinationID = 301 AND CR_Origin='Sydney'), 'Sydney', 'London');
